...
public class PlatformGenerator : GeneratorBase
{
    ...
    protected override void ExecGenerator()
    {
    ...
    protected override void DeletePlatforms()
    {
        ...
        var platformsToDelete = SpawnedPlatforms.Take(groupToDeletePlatformsCount);
    ...
    private void SpawnPlatform(int stepsCount)
    {
        ...
        for (int i = 0; i < platformsToSpawnCount; i++)
        {
            ...
            var randomPlatform = _platformPrefabs[Random.Range(0, _platformPrefabs.Count)];
